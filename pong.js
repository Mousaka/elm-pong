...
var _user$project$Main$getRect = F2(
	function (xPos, yPos) {
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$svg$Svg_Attributes$x(xPos$),
					_elm_lang$svg$Svg_Attributes$y(yPos$),
					_elm_lang$svg$Svg_Attributes$width('15'),
...
var _user$project$Main$dotNet = function (yPos) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$svg$Svg_Attributes$x('692'),
				_elm_lang$svg$Svg_Attributes$y(
				_elm_lang$core$Basics$toString(yPos)),
				_elm_lang$svg$Svg_Attributes$width('16'),
				_elm_lang$svg$Svg_Attributes$height('16'),
				_elm_lang$svg$Svg_Attributes$fill('white')
			]),
		_elm_lang$core$Native_List.fromArray(
			[]));
...
var _user$project$Main$drawNetHelp = F2(
	function (yPos, list) {
		drawNetHelp:
		while (true) {
			var _p0 = _elm_lang$core$Native_Utils.cmp(yPos, 0) > 0;
			if (_p0 === true) {
				var _v1 = yPos - 50,
					_v2 = A2(
...
var _user$project$Main$background = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$svg$Svg_Attributes$width('1400'),
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					'velocity: ',
					_elm_lang$core$Basics$toString(player.velocity))),
				_elm_lang$html$Html$text(
				A2(
					_elm_lang$core$Basics_ops['++'],
					'y: ',
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$svg$Svg_Attributes$viewBox('0 0 1400 1000'),
						_elm_lang$svg$Svg_Attributes$width('700px'),
						_elm_lang$svg$Svg_Attributes$height('500px')
					]),
				A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Native_List.fromArray(
